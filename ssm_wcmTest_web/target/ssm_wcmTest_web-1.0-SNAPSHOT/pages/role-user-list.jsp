									...
									<c:forEach items="${roleList}" var="role">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/role/findUserByRid?id=${role.id}" class="btn bg-olive btn-xs">详情</a>
												<a href="${pageContext.request.contextPath}/user/findUserByIdAndAllRole.do?id=${user.id}" class="btn bg-olive btn-xs">更改用户</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
