						...
						<div class="table-box">
							...
							<div class="box-tools pull-right">
								<div class="has-feedback">
									<input name="search_input" id="search_input" type="text" class="form-control input-sm"
										placeholder="请输入搜索的关键字">
									<a href="javascript:;" id="search-button" class="search-button">
							...
							<table id="dataList"
								...
								<tbody>
									...
									<c:forEach items="${pageInfo.list}" var="product">
										...
										<tr>
											<td><input name="ids" class="ids"  value="${product.id}" type="checkbox"></td>
											<td>${product.id }</td>
						...
						<div class="pull-left">
							<div class="form-group form-inline">
								...
								每页 <select class="form-control"
										   ...
										   id="changePageSize" onchange="changePageSize()">
									<option>1</option>
									<option>2</option>
									<option>3</option>
									<option>4</option>
	...
	<script>
		...
		$(function () {
            ...
            $("#search-button").click(function () {
                //线路名称
                var fs = $("#search_input").val();
					alert(fs);
                //判断rname如果不为null或“”
				//搜索若为空，提示请输入要搜索的内容
				 if (fs){
                    //url解码
                     fs = window.decodeURIComponent(fs)
                     //跳转路径
                     window.location.href="${pageContext.request.contextPath}/product/findAll";
				}else {
				     alert("请输入要搜索的内容");
				 }
			...
			$("#delete").click(function () {
				...
				var cks= $(".ids");
				var ckval=new Array(0);
				for (var i =0;i<cks.length;i++){
				    //判断是否被选择
					if (cks[i].checked){
						ckval.push(cks[i].value)
					}
				}
				if (ckval.length>0){
				    ...
				    if (flag){
                        window.location.href="${pageContext.request.contextPath}/product/delete?ids="+ckval;
                    }else{
				        alert("手别抖");
					}
