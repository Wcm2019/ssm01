...
<body class="hold-transition skin-purple sidebar-mini">
							...
							<div class="box-tools pull-right">
								<div class="has-feedback">
									<input   type="text" class="form-control input-sm"
										   placeholder="请输入搜索的关键字" id="serachName">

											<span class="glyphicon glyphicon-search " id="serach" ></span>
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline" >
                            ...
                            <select class="form-control"  id="changePageSize2" onchange="changePageSize2()">
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                                <option>4</option>
	...
	<script>
		function changePageSize2() {
			//获取下拉框的值
			var pageSize = $("#changePageSize2").val();
		...
		$(document).ready(function() {
            ...
            $("#serach").click(function () {
                //线路名称
                var serachValue = $("#serachName").val();

                location.href="${pageContext.request.contextPath}/orders/findAll?serachValue="+serachValue;
